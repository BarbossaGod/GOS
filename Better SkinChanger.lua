...
skinMeta       = 
{
	...
	["Bard"] = {"Classic", "Elderwood", "Chroma1", "Chroma2", "Chroma3", "Snow Day"},
	...
	["Morgana"] = {"Classic", "Exiled", "Sinful Succulence", "Blade Mistress", "Blackthorn", "Ghost Bride", "Victorious", "Chroma1", "Chroma2", "Chroma3", "Lunar Wraith"},
	["Nami"] = {"Classic", "Koi", "River Spirit", "Chroma1", "Chroma2", "Chroma3", "Urf the"},
	["Nasus"] = {"Classic", "Galactic", "Pharaoh", "Dreadknight", "Riot K-9", "Infernal", "Chroma1", "Chroma2", "Chroma3", "Archduke"},
	...
	["Tristana"] = {"Classic", "Riot Girl", "Earnest Elf", "Firefighter", "Guerilla", "Buccaneer", "Rocket Girl", "Chroma1", "Chroma2", "Chroma3", "Dragon Trainer"},
